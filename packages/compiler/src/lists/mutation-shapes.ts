 ...
 *
 * Compiler-owned JSX map and separately proven append-only push calls enable
 * specializations. Other candidates retain ordinary reconciliation. Property
 * writes (including length and indexed replacement) are not method calls and
 * do not belong here.
 */
