...
export function App() {
  return (
    <div className="min-h-screen flex flex-col bg-base text-ink transition-colors duration-200">
      ...
      <footer className="border-t border-line bg-base py-6 text-center text-xs text-ink-faint font-mono">
